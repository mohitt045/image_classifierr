...
def get_b64_test_image_for_anuj():
    with open("b64.txt") as f:
        return f.read()

if __name__ == '__main__':
    load_saved_artifacts()
    print(classify_image(get_b64_test_image_for_anuj(),None))
    print(classify_image(None,"./test_images/moh.jpg"))
    #print(classify_image(None,"./test_images/vritti1.png"))
    print(classify_image(None,"./test_images/krish.jpg"))